    ...
    partial class Program
    {
        public class Delay : Setting
        {
            ...
            public override void DrawSetting(List<MySprite> sprites, float x, float y, float w, float h, DrawParams _dp)
            {
                ...
                var tpSet = new TimeParams(g_time, 0, 0, null, g_session.CurClip.EditLengthIndex, g_session.CurClip.CurSrc, _triggerDummy, _dp.Program);
                ...
                { 
                    ...
                    var tp  = new TimeParams(0, 0, 0, null, g_session.CurClip.EditLengthIndex, g_session.CurClip.CurSrc, _triggerDummy, _dp.Program);
